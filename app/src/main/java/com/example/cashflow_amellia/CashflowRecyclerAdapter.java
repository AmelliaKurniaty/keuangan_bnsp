...
public class CashflowRecyclerAdapter extends RecyclerView.Adapter<com.example.cashflow_amellia.CashflowRecyclerAdapter.CashflowViewHolder> {
    private List<com.example.cashflow_amellia.Cashflow> listCashflow;

    public CashflowRecyclerAdapter(List<com.example.cashflow_amellia.Cashflow> listCashflow) {
    ...
    public int getItemCount() {
        Log.v(com.example.cashflow_amellia.CashflowRecyclerAdapter.class.getSimpleName(),""+listCashflow.size());
