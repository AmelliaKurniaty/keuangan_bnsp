...
public class PemasukanActivity extends AppCompatActivity {
    ...
    private com.example.cashflow_amellia.Cashflow cashflow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cashflow = new com.example.cashflow_amellia.Cashflow();
        ...
        kalendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(com.example.cashflow_amellia.PemasukanActivity.this, date, myCalendar
